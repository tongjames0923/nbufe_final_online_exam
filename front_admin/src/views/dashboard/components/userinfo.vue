<template>
    <div style="padding:10px">
        ...
        <el-input style="margin-bottom: 6px;" type="email" v-model="info.email" :disabled=!editable>
            <template slot="prepend">电子邮件</template>
        </el-input>
        <el-input style="margin-bottom: 6px;" v-model="info.address" :disabled=!editable>
            <template slot="prepend">联系地址</template>
        </el-input>
        <el-input style="margin-bottom: 6px;" v-model="info.note" :disabled=!editable>
        ...
        <el-button @click="updateInfo" v-if="editable">更新信息</el-button>
        <el-button @click="resetthis" v-if="editable">恢复个人信息</el-button>
    </div>
